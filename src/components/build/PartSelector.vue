<template>
  <div class="part" :class="position">
    ...
    <!-- <span v-pin:position.top.left class="sale" v-show="selectedPart.onSale"
      >Sale!</span
    > -->
    <span
      @click="pinPadding += 5"
      v-pin="{ bottom: pinPadding + 'px', right: pinPadding + 'px' }"
      class="sale"
...
export default {
  ...
  data() {
    return { selectedPartIndex: 0, pinPadding: 5 };
  },
  computed: {
    selectedPart() {
